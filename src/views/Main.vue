    ...
    <div>
        ...
        <div class="py-5 mx-10 flex justify-between items-center">
            ...
            <div v-if="!auth">
                ...
                <router-link
                    class="
                        no-underline text-brown border-2 px-3
                        py-2 hover:text-brown-darkest hover:border-brown-darkest
                        rounded-full border-brown ml-3"
                    to="/auth/register">Join Now</router-link>
            </div>
            <div v-else>
                <span
                class="cursor-pointer text-brown hover:text-brown-darkest"
                @click="unsetAuth">Logout</span>
            </div>
        </div>
